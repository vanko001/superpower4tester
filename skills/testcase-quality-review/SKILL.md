...
- **Expected Result Oracle**: Reject UI expected results that cannot be traced to both a Document Oracle and a Browser Oracle. Reject expected results that describe warning/error colors without screenshot or computed style evidence.
